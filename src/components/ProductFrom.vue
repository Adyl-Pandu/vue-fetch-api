...
const ifUpdate = computed(() => !!props.product);

const emit = defineEmits(["created-product", "update-product"]);
...
function saveProduct() {
  ...
  if (ifUpdate.value) {
    ...
    console.log("Emit create with data:", formData); // Debug
    emit("update-product", formData);
  }
  if (!ifUpdate.value) {
    // reset hanya kalau create baru
    title.value = "";
    description.value = "";
    price.value = "";
    image.value = "";
...
<template>
  <div class="form-container">
    <button @click="showForm = !showForm">Product</button>
